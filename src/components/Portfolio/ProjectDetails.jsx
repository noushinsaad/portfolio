        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    className="bg-gray-900 p-8 rounded-xl shadow-2xl max-w-lg w-full mx-4 border border-gray-800"
                >
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            onClick={onClose}
                            className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-md text-sm transition-colors duration-300"
                        >
                            <span>Close</span>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
